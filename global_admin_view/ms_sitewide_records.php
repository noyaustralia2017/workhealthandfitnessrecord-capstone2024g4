<?php
/*
Template Name: Musculoskeletal Assessment Records Site-Wide - Admins
*/
...
<style>
    ...
    .button:hover {
        ...
        echo '<h2 id="head">Site-Wide Musculoskeletal Assessment Records</h2>';
...
<br>'; // Add spacing between search input and download button
    ...
    ';
        echo '
    <thead><tr><th>User Name</th><th>Email Domain</th><th>Date</th><th>Condition of your musculoskeletal system</th><th>Ideal Weight</th><th>Squats 60s</th><th>Sit-ups 60s</th><th>Press-ups 60s</th><th>hamstring flexability</th><th>sit up straight with legs cross</th><th>shoulder function</th><th>systematic strength training program</th><th>systamatic flexability traning program</th><th>Total </th></thead>';  // This is where you need to edit
        echo '
    <tbody>
        ';
...
<script>
    ...
    function downloadCSV(rows) {
        ...
        link.setAttribute("download", "ms_assessment_records.csv");
