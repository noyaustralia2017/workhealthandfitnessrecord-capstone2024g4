<?php
/*
Template Name: Joint Specific Assessment Records Site-Wide - Admins
*/
...
<style>
    ...
    .button:hover {
        ...
        echo '<h2 id="head">Site-Wide Joint Specific Assessment Records</h2>';
...
<br>'; // Add spacing between search input and download button
    ...
    ';
        echo '
    <thead><tr><th>User Name</th><th>Email Domain</th><th>Date</th><th>Lower Back</th><th>Upper Back</th><th>Neck</th><th>Right Shoulder</th><th>Left Shoulder</th><th>Right Wrist</th><th>Left Wrist</th><th>Right Hip</th><th>Left Hip</th>
          <th>Right Knee</th><th>Left Knee</th><th>Right Leg</th><th>Left Leg</th><th>Right Food</th><th>Left Foot</th><th>Total</th></tr></thead>';  // This is where you need to edit
        echo '
    <tbody>
        ';
...
<script>
    ...
    function downloadCSV(rows) {
        ...
        link.setAttribute("download", "specific_joint_assessment_records.csv");
    ...
    echo '<p style="font-size:25px">Access denied.</p>';
}
