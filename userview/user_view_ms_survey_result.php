<?php
/*
Template Name: MS Survey Results - User View
*/
...
if (is_user_logged_in()) {
    ...
    $attendance_records = $wpdb->get_results(
        $wpdb->prepare(
            "SELECT * FROM ms_survey WHERE user_id = %d ORDER BY date ASC",
            $user_id
        )
    );
...
';
        echo '<h2 id="head">My Musculoskeletal Assesment Records</h2>';
...
echo '<thead><tr><th>Date</th><th>Condition of your musculoskeletal system</th><th>Ideal Weight</th><th>Squats 60s</th><th>Sit-ups 60s</th><th>Press-ups 60s</th><th>hamstring flexability</th><th>sit up straight with legs cross</th><th>shoulder function</th><th>systematic strength training program</th><th>systamatic flexability traning program</th><th>Total </th></thead>';  
