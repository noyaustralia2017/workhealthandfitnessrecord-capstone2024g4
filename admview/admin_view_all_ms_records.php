<?php
/*
Template Name: MS Assesment Records Org-Wide - Admins
*/
...
foreach ($shared_seminar_records as $record) {
    ...
    $user_email = $user_info ? $user_info->user_email : 'Unknown Email';
