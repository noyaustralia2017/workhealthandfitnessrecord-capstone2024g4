<?php
/*
Template Name: Universal Fitness Assesment Records Org-Wide - Admins
*/
...
if (is_user_logged_in() && (current_user_can('administrator') || current_user_can('contributor') || current_user_can('WHS'))) {
    ...
    $shared_seminar_records = $wpdb->get_results(
        $wpdb->prepare(
            "SELECT * FROM universal_fitness_survey
...
<style>
    ...
    .button {
        ...
        echo '<h2 id="head">Org-Wide Universal Fitness Assesment Records</h2>';
...
<thead>
    <tr>
        ...
        <th>Pressups</th>
        <th>Hamstring</th>
        <th>Right leg on top sitting</th>
        <th>Left leg on top sitting</th>
        <th>Shoulder function</th>
        <th>Aerobic Fitness</th>
        <th>Total</th>
    </tr>
</thead>';
